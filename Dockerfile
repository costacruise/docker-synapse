...
RUN apk add --no-cache su-exec libffi zlib zlib libressl libjpeg-turbo libpq libxslt \
 && apk add --no-cache --virtual .build_deps build-base libffi-dev zlib-dev libressl-dev libjpeg-turbo-dev linux-headers postgresql-dev libxslt-dev \
